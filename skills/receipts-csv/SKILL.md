...
description: >-
  ...
  verdict (REAL_CHANGE / NO_REAL_CHANGE), explicit incompatibility
  and refusal handling, and a content-
...
5. **Stop/refusal from any stage** — surface the structured envelope or report verbatim. Do not paraphrase or "fix" it; `shape INCOMPATIBLE` stops before `rvl`, and refusal codes are the contract.
